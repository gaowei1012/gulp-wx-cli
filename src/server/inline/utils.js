...
const KEY = 'a54b1c81d8e343929a3a79659040a51a'   //和风天气中应用的key名称
const USER_ID = 'HE1905101057491673' //和风天气中应用的密钥ID

const WECHAT_APPID = 'wxbde07b4f35495337' // 微信appid
const WECHAT_APP_SECRET = '8bfebda050dbefce68afc7094bf6ce7f' // 微信 app_secret
const $ = {
  getWechatAppConfig: () => {
    return {
      id: WECHAT_APPID,
